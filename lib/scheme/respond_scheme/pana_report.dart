...
class PanaReport extends JsonScheme {
  PanaReport(super.rawData);
  ...
  String? get timestamp {
    try {
      if (rawData["timestamp"] is String == false) {
        return null;
      }
      return rawData["timestamp"] as String;
    } catch (e) {
      return null;
    }
  }
  ...
  set timestamp(String? value) {
    rawData["timestamp"] = value;
  }

  PanaRuntimeInfo get panaruntimeinfo {
    try {
      if (rawData["panaRuntimeInfo"] is Map == false) {
        return PanaRuntimeInfo({});
      }
      return PanaRuntimeInfo(rawData["panaRuntimeInfo"] as Map);
    } catch (e) {
      return PanaRuntimeInfo({});
    }
  }

  set panaruntimeinfo(PanaRuntimeInfo value) {
    rawData["panaRuntimeInfo"] = value.toJson();
  }
  ...
  List<String> get derivedtags {
    try {
      if (rawData["derivedTags"] is List == false) {
        return [];
      }
      return (rawData["derivedTags"] as List).cast<String>();
    } catch (e) {
      return [];
    }
  }

  set derivedtags(List<String> value) {
    rawData["derivedTags"] = value;
  }
  ...
  List<String> get alldependencies {
    try {
      if (rawData["allDependencies"] is List == false) {
        return [];
      }
      return (rawData["allDependencies"] as List).cast<String>();
    } catch (e) {
      return [];
    }
  }

  set alldependencies(List<String> value) {
    rawData["allDependencies"] = value;
  }
  ...
  Report get report {
    try {
      if (rawData["report"] is Map == false) {
        return Report({});
      }
      return Report(rawData["report"] as Map);
    } catch (e) {
      return Report({});
    }
  }
  ...
  Result get result {
    try {
      ...
      return Result(rawData["result"] as Map);
    } catch (e) {
      return Result({});
    }
  }
  ...
  ///
  ///
  List<Object> get screenshots {
    try {
      if (rawData["screenshots"] is List == false) {
        return [];
      }
      return (rawData["screenshots"] as List).cast<Object>();
    } catch (e) {
      return [];
    }
  }

  set screenshots(List<Object> value) {
    rawData["screenshots"] = value;
  }
  ...
  ///
  ///
  List<Object> get urlproblems {
    try {
      if (rawData["urlProblems"] is List == false) {
        return [];
      }
      return (rawData["urlProblems"] as List).cast<Object>();
    } catch (e) {
      return [];
    }
  }

  set urlproblems(List<Object> value) {
    rawData["urlProblems"] = value;
  }

  static PanaReport create({
    bool schemeUtilsIsSetDefaultData = false,
    String special_type = "panaReport",
    String? timestamp,
    ...
    Report? report,
    Result? result,
    List<Object>? screenshots,
    List<Object>? urlproblems,
  }) {
    // PanaReport panaReport = PanaReport({
    final Map panaReport_data_create_json = {
      "@type": special_type,
      "timestamp": timestamp,
      "panaRuntimeInfo":
          (panaruntimeinfo != null) ? panaruntimeinfo.toJson() : null,
      "reportStatus": reportstatus,
      "derivedTags": derivedtags,
      "allDependencies": alldependencies,
      "licenses": (licenses != null) ? licenses.toJson() : null,
      "report": (report != null) ? report.toJson() : null,
      "result": (result != null) ? result.toJson() : null,
      "screenshots": screenshots,
      "urlProblems": urlproblems,
    };

    panaReport_data_create_json.removeWhere((key, value) => value == null);

    if (schemeUtilsIsSetDefaultData) {
      defaultData.forEach((key, value) {
        if (panaReport_data_create_json.containsKey(key) == false) {
          panaReport_data_create_json[key] = value;
        }
      });
    }
    return PanaReport(panaReport_data_create_json);
  }
}
