...
class PubDevPackageMetrics extends JsonScheme {
  PubDevPackageMetrics(super.rawData);
  ...
  /// check data
  /// if raw data
  /// - rawData["@type"] == pubDevPackageMetrics
  /// if same return true
  ...
  /// create [PubDevPackageMetrics]
  /// Empty
  static PubDevPackageMetrics empty() {
    return PubDevPackageMetrics({});
  }
  ...
  Score get score {
    try {
      if (rawData["score"] is Map == false) {
        return Score({});
      }
      return Score(rawData["score"] as Map);
    } catch (e) {
      return Score({});
    }
  }
  ...
  set score(Score value) {
    rawData["score"] = value.toJson();
  }

  Scorecard get scorecard {
    try {
      if (rawData["scorecard"] is Map == false) {
        return Scorecard({});
      }
      return Scorecard(rawData["scorecard"] as Map);
    } catch (e) {
      return Scorecard({});
    }
  }

  set scorecard(Scorecard value) {
    rawData["scorecard"] = value.toJson();
  }

  static PubDevPackageMetrics create({
    bool schemeUtilsIsSetDefaultData = false,
    String special_type = "pubDevPackageMetrics",
    Score? score,
    Scorecard? scorecard,
  }) {
    // PubDevPackageMetrics pubDevPackageMetrics = PubDevPackageMetrics({
    final Map pubDevPackageMetrics_data_create_json = {
      "@type": special_type,
      "score": (score != null) ? score.toJson() : null,
      "scorecard": (scorecard != null) ? scorecard.toJson() : null,
    };

    pubDevPackageMetrics_data_create_json
        .removeWhere((key, value) => value == null);

    if (schemeUtilsIsSetDefaultData) {
      defaultData.forEach((key, value) {
        if (pubDevPackageMetrics_data_create_json.containsKey(key) == false) {
          pubDevPackageMetrics_data_create_json[key] = value;
        }
      });
    }
    return PubDevPackageMetrics(pubDevPackageMetrics_data_create_json);
  }
}
