...
class Score extends JsonScheme {
  Score(super.rawData);
  ...
  static Score create({
    ...
    // Score score = Score({
    final Map score_data_create_json = {
      "@type": special_type,
    ...
    score_data_create_json.removeWhere((key, value) => value == null);

    if (schemeUtilsIsSetDefaultData) {
      defaultData.forEach((key, value) {
        if (score_data_create_json.containsKey(key) == false) {
          score_data_create_json[key] = value;
        }
      });
    }
    return Score(score_data_create_json);
  }
}
